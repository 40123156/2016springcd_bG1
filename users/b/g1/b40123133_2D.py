...
@scrum40123133_task1.route('/circle')
def three():
    outstring = '''
...
class chain():
    ...
    chamber = "M5.000 42.998 L10.399,42.998 L10.399,26.279 L30.397,26.279 L30.397,5.000 L5.397,5.000 L5.000,42.998 M12.442 9.993 L24.904,9.993 L24.904,20.789 L12.442,20.789 L12.442,9.993 "
