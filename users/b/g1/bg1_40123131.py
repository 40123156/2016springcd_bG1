...
bg1_40123131 = Blueprint('bg1_40123131', __name__, url_prefix='/bg1_40123131', template_folder='templates')


@bg1_40123131.route('/2D')
def theer():
    outstring = '''
...
class chain():
    ...
    chamber = "M5.000 5.000 L37.300,14.000 L46.900,45.800 L47.100,5.200 L5.000,5.000  "
    ...
    def basic_rot(self, x1, y1, rot, v=False):
        ...
        hole = cobj(shapedefs.circle(1*self.scale), "PATH")
        cmbr.appendPath(hole)
        basic1 = cmbr.dup()
...
x1, y1 = mychain.basic_rot(50,50, 90)
